     ...
     return (  
          <section className="w-full h-screen xl:p-8 bg-transparent flex flex-col md:flex-row">
               ...
               <div className="bg-white w-full rounded-l-md pt-8 flex items-center flex-col h-full">
                    ...
                    <section className="flex w-full md:w-[700px] flex-col mt-8 flex-1 px-6 sm:px-14 py-6 gap-y-10">
                         <InputCommon 
                              icon={
                    ...
                    <section className="w-full pb-6 flex justify-between items-center px-6">
                         <Link href={'/auth/register/confirm_phone_number'} className="mt-6 rounded-md flex gap-x-4 font-iranyekan-bold text-blue-600">
                              مرحله قبل 
                         </Link>
                         <Link href={'/auth/register/choose_location'} className="bg-blue-500 hover:bg-blue-600 duration-150 mt-6 rounded-md flex gap-x-4 font-iranyekan-bold text-blue-50 px-6 py-3">
                              مرحله بعد
