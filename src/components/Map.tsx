        ...
        <div className='relative w-full h-full rounded-xl overflow-hidden'>
            <MapContainer className='h-full absolute inset-0 z-10' center={position} zoom={13}>
                ...
                <Marker
                    ...
                    eventHandlers={{
                        dragend: (e: any) => setPosition([e.target.getLatLng().lat, e.target.getLatLng().lng]),
                    }}
                />
            ...
            <div className='absolute z-20 left-0 right-0 w-fit bottom-5 mx-auto flex gap-x-4 justify-center items-center'>
                <button
                    ...
                    className='bg-gray-500 text-sm hover:bg-gray-600 duration-150 rounded-md font-iranyekan-bold text-blue-50 px-6 py-3'
                >
                    بستن
                </button>
                ...
                <button
                    ...
                    className='bg-orange-500 text-sm hover:bg-orange-600 duration-150  rounded-md flex gap-x-3 font-iranyekan-bold text-blue-50 px-6 py-3'
                >
                    ثبت موقعیت
                    <svg
